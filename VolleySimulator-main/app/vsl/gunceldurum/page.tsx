...
export default function VSLDetailedPage() {
    const [loading, setLoading] = useState(true);
    const [teams, setTeams] = useState<TeamStats[]>([]);
    const [matches, setMatches] = useState<Match[]>([]);

    // VSL is a single group league
    ...
    // Mathematical Calculations for Candidates (Simplified for single group 14 teams)
    // Top 4 Playoffs
    // Relegation: Last 2? (Need to confirm logic, assuming standard 2 relegation for now)
