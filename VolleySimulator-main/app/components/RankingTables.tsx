    ...
    return (
        <div className="bg-gradient-to-br from-slate-800/95 to-slate-900/95 rounded-xl border border-slate-700/50 overflow-hidden shadow-xl">
            ...
            <div className="px-4 py-3 bg-slate-900/50 border-t border-slate-800 flex flex-wrap gap-4 justify-center sm:justify-start">
                <div className="flex items-center gap-1.5 text-[10px] text-emerald-300 font-medium bg-emerald-500/10 px-2 py-1 rounded border border-emerald-500/20">
                    <span className="font-bold">{t('table.won')}:</span> {language === 'tr' ? 'Galibiyet' : 'Won'}
                </div>
                <div className="flex items-center gap-1.5 text-[10px] text-amber-300 font-medium bg-amber-500/10 px-2 py-1 rounded border border-amber-500/20">
                ...
                <div className="flex items-center gap-1.5 text-[10px] text-sky-300 font-medium bg-sky-500/10 px-2 py-1 rounded border border-sky-500/20">
                    <span className="font-bold">{t('table.pointsWon')}:</span> {language === 'tr' ? 'Alınan Sayı' : 'Points Won'}
                </div>
                <div className="flex items-center gap-1.5 text-[10px] text-rose-300 font-medium bg-rose-500/10 px-2 py-1 rounded border border-rose-500/20">
